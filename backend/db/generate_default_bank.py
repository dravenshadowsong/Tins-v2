...
def generate_bank():
    ...
    discovery_questions = [
        ...
        },
        {
            ...
            "domain": "kinesthetic",
            "component": "discovery",
            "title": {"English": "Explaining to a Friend", "Hindi": "दोस्त को समझाना"},
            "prompt": {
                "English": "When you want to explain how to do something, what feels most natural to you?",
                "Hindi": "जब आप किसी को कुछ करने का तरीका समझाना चाहते हैं, तो आपको क्या सबसे आसान लगता है?"
            },
            "options": [
                {"label": {"English": "Act it out or demonstrate it with your body", "Hindi": "खुद करके या शरीर से दिखाना"}, "value": 0, "domains": ["kinesthetic"]},
                {"label": {"English": "Draw a diagram or write the steps", "Hindi": "आरेख बनाना या चरण लिखना"}, "value": 1, "domains": ["logical", "spatial"]},
                {"label": {"English": "Make up a creative story or example", "Hindi": "एक रचनात्मक कहानी या उदाहरण बनाना"}, "value": 2, "domains": ["creative"]},
                {"label": {"English": "Think quietly about it first before saying anything", "Hindi": "पहले चुपचाप सोचना फिर कहना"}, "value": 3, "domains": ["intrapersonal"]}
            ],
            "metric": "preference",
            "difficulty": "easy",
            "ai_interpretation_notes": "Measures kinesthetic, logical, spatial, creative, and intrapersonal preferences for explanation style."
        },
        {
            "key": "q_discovery_10",
            "type": "choice",
            "domain": "kinesthetic",
            "component": "discovery",
            "title": {"English": "Weekend Activity", "Hindi": "सप्ताहांत की गतिविधि"},
            "prompt": {
                "English": "Which activity sounds most exciting for a free afternoon?",
                "Hindi": "एक खाली दोपहर के लिए कौन सी गतिविधि सबसे रोमांचक लगती है?"
            },
            "options": [
                {"label": {"English": "Talking and laughing with a group of friends", "Hindi": "दोस्तों के साथ बातें करना और हँसना"}, "value": 0, "domains": ["social", "language"]},
                {"label": {"English": "Playing a sport, doing gymnastics, or dancing", "Hindi": "खेल खेलना, जिमनास्टिक करना या नाचना"}, "value": 1, "domains": ["kinesthetic"]},
                {"label": {"English": "Exploring nature — bugs, plants, or the sky", "Hindi": "प्रकृति की खोज — कीड़े, पौधे या आसमान"}, "value": 2, "domains": ["naturalist"]},
                {"label": {"English": "Sitting quietly with a journal or personal project", "Hindi": "चुपचाप बैठकर डायरी लिखना या निजी प्रोजेक्ट करना"}, "value": 3, "domains": ["intrapersonal"]}
            ],
            "metric": "preference",
            "difficulty": "easy",
            "ai_interpretation_notes": "Measures social, language, kinesthetic, naturalist, and intrapersonal leisure preferences."
        }
    ]
