...
def generate_bank():
    ...
    core_deep_questions = [
        ...
        },
        {
            ...
            "prompt": {
                "English": "Cow, horse, dog, crow — which one is different from the rest, and why?",
                "Hindi": "गाय, घोड़ा, कुत्ता, कौवा — इनमें से कौन सा अलग है और क्यों?"
            },
            "options": [
                {"label": {"English": "Crow — it is the only one with wings and two legs, not four", "Hindi": "कौवा — सिर्फ इसी के पंख हैं और दो पैर हैं, न कि चार"}, "value": 4},
                {"label": {"English": "Dog — it is the only pet that lives inside a house", "Hindi": "कुत्ता — वह अकेला घर के अंदर रहने वाला पालतू जानवर है"}, "value": 1},
                {"label": {"English": "Horse — it is the biggest and fastest animal in the list", "Hindi": "घोड़ा — वह सूची में सबसे बड़ा और तेज जानवर है"}, "value": 0},
                {"label": {"English": "Cow — it is the only one that gives milk", "Hindi": "गाय — वह अकेली दूध देने वाली है"}, "value": 0}
            ],
            "answer": "Crow — it is the only one with wings and two legs, not four",
            "metric": "correctness",
            "difficulty": "medium",
            "ai_interpretation_notes": "Tests classification and categorical reasoning. The child must identify the structural property (leg count / body type) that groups cow, horse, and dog together and excludes the crow. Distractors test surface-level reasoning vs. structural logic."
        },
        # --- SPATIAL & MAKING ---
        {
        ...
        },
        {
            ...
            "prompt": {
                "English": "An arrow drawn on a piece of paper is pointing UPWARD. You pick up the paper and turn it around completely (like flipping a chapati). Which direction does the arrow point now?",
                "Hindi": "एक कागज पर खींचा गया तीर ऊपर की ओर इशारा कर रहा है। आप कागज को उठाते हैं और उसे पूरी तरह पलट देते हैं (जैसे चपाती पलटते हैं)। अब तीर किस दिशा में इशारा करेगा?"
            },
            "options": [
                {"label": {"English": "Downward", "Hindi": "नीचे की तरफ"}, "value": 4},
                {"label": {"English": "To the left", "Hindi": "बाईं तरफ"}, "value": 1},
                {"label": {"English": "Still upward — it does not change", "Hindi": "अभी भी ऊपर की तरफ — यह नहीं बदलता"}, "value": 0},
                {"label": {"English": "To the right", "Hindi": "दाईं तरफ"}, "value": 0}
            ],
            "answer": "Downward",
            "metric": "correctness",
            "difficulty": "easy",
            "ai_interpretation_notes": "Tests 2D spatial rotation using a concrete everyday action (flipping a roti/chapati). No academic knowledge of degrees required — tests pure mental rotation ability."
        },
